...
class Repressilator(TestBed):
    def __init__(self):
        # inherit class Testbed
        super().__init__()

    # when you need a utility function that doesn't access any properties
    # of a class but makes sense that it belongs to the class (staticmethod)
    @staticmethod
